...
<!--product details-->
 <aside class="3">
    <img src="../imagess/hr1.png" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">মায়া ভিলা </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"> কৃষ্ণেন্দু মুখোপাধ্যায়</span></p>
    <hr>

   

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">মিত্র ও ঘোষ পাবলিশার্স<br>৳ 180</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 180<br>
    M.R.P: <del>৳ 270</del><br>
    You save: ৳ 90<br>
...
<section class="row">
  ...
  প্রযোজক সৈকত সান্যাল সত্যি ঘটনা অবলম্বনে একটা ভৌতিক সিনেমার জন্য গল্প খুঁজছিলেন। তাঁকে সেই গল্পের সন্ধান দেন অসীম ব্যানার্জ্জী। ডায়মণ্ড হারবার থেকে একটু দূরে এক পরিত্যক্ত বাড়ি মায়া ভিলা।<button id="sh">Read more...</button>
    <p id="pp">মায়া ভিলায় দ্বিতীয় বিশ্বযুদ্ধের সময় বাস করত এক রহস্যময় পরিবার। স্থানীয়দের কাছে এই বাড়ির ইতিহাস আর অপ্রাকৃতিক লোককথা শুনে চিত্রনাট্য লিখতে গিয়ে আশ্চর্যজনক ভাবে উন্মাদ হয়ে যান অসীম ব্যানার্জ্জী।

তারপরে আরেক চিত্রনাট্যকার রমেন পোদ্দার বাকি কাজটুকু এগিয়ে নিয়ে যেতে গিয়ে নিখোঁজ হয়ে যান।

নিতান্ত ছোট কাগজের সাংবাদিক দেবরাজ তাদের কাগজের শেষ রিপোর্টিং লিখতে গিয়ে হাজির হন মায়া ভিলায়। সেখানে দেখা হয় কাগজের সাংবাদিক ঈশা সেনের সঙ্গে।

পরতে পরতে রোমাঞ্চ আর ভৌতিক অভিজ্ঞতায় শেষ পর্যন্ত উন্মোচিত হয় মায়া ভিলার বিচিত্র মর্মস্পর্শী ইতিহাস।</p>
