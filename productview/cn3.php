...
<!--product details-->
 <aside class="3">
    <img src="../imagess/cn3.png" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">লংকা কান্ড </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">মেহেদী হক</span></p>
    <hr>


    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">ঢাকা কমিক্স<br>৳ 130</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 130<br>
...
<section class="row">
  ...
  মেহেদী হক এর লংকা কাণ্ড (মালদ্বীপ ফ্রি) অরিজিনাল বইটি সংগ্রহ করুন, <button id="sh">Read more...</button>
    <p id="pp">.</p>
