...
<body>
  ...
  <a class="navbar-brand" href="../index.php">
    <img class="profile" src="logo/G9 LOGO1.png" alt="logo" style="width:65px;">
  </a>
  ...
  <ul class="navbar-nav">
   ...
   <li class="nav-item icn">
      <a class="nav-link" href="../missingcart.php"><i style="font-size:25px;margin-left:20px;"class="fas fa-cart-plus"></i></a>
   </li>
  </ul>
</nav>
<section class="row">
...
<!--product details-->
 <aside class="3">
    <img src="../imagess/BS2.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">আল কুরআন এক মহাবিস্ময়</span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"> ড. মরিস বুকাইলি</span></p>
    <hr>


    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">বাংলাদেশ ইসলামিক সেন্টার<br>৳ 350</p><br>

    <p>Delivery By: Tuesday, August 25 <a href="#">Details</a><span></span></p>
    ...
    <p><a href="#"  class="log"  style="font-size:12px;">No-contact Delivery</a><a href="#"  class="log" style="font-size:12px;">10 Days Replacement Only</a>
    <a href="#"  class="log" style="font-size:12px;">G-9 Book Shop Delivery</a></p>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 350<br>
    M.R.P: <del>৳ 500</del><br>
    You save: ৳ 150<br>
  ...
  <p> <span style="color:green;font-weight:bold;font-size:20px;margin-left:20px;">In Stock</span><br>
    <span style="margin-left:20px;">Sold by <a href="#">G-9 Book Shop</a></span>
  </p>
  <a class="form-control" href="http://localhost/9/user/login.php" button type="button" class="btn btn-light bt" style="text-align:center;background-color:aqua">Add to cart</button></a>
    <p style="margin-left:20px;"><i class="material-icons">add_location</i>Delivered 200 copies</p>
  </aside>
<!--next section-->
<section class="row">
  <article class="col-md-6" style="margin-left:320px;">
  আল কুরআন এক মহাবিস্ময় হচ্ছে আল কুরআনকে আধুনিক বিজ্ঞানের সাথে তুলনা করে তার যুক্তিযুক্ত ব্যাখার এক গবেষণামূলক বই ।
আধুনিক বিজ্ঞানের মুখোমুখি দাঁড় করানো হয়েছে দেড় হাজার বছরের প্রাচীন গ্রন্থ আল কুরআনকে। একটিতে আছে বিশ্বাস আর একটি চায় প্রমাণ। <button id="sh">Read more...</button>
    <p id="pp">তবে অবাক করা বিষয় হলো আধুনিক বিজ্ঞানের সব প্রমাণ নিয়েই আল কুরআন তার স্ব-মহিমায় বিরাজমান।
ডঃ মরিস বুকাইলের গবেষনামূলক গ্রন্থ The Bible,The Quran and Scienceপ্রকাশিত হলে পৃথিবীব্যাপী ব্যাপক সাড়া পরে যায়।
সে সময়ে তিনি নানা রকম গুঞ্জন আর সমালোচনার জবাব দিতে ফরাসি চিকিৎসাবিজ্ঞানীদের একাডেমিতে এক বক্তৃতা দেন, সে বক্তৃতাই এ বইটাতে স্থান পেয়েছে।
ডঃ বুকাইলের মতে, ‘কুরআনে এমন একটি বক্তব্যও নেই যা আধুনিক বৈজ্ঞানিক দৃষ্টিকোন থেকে আক্রমণযোগ্য।’ এ বইয়ে তিনি মহাবিশ্ব, পৃথিবী আর মানুষ সৃষ্টি নিয়ে আলোচনা করেন আর সে সব তথ্য বৈজ্ঞানিক কষ্টিপাথরে যাচাই করে প্রমাণ দেন ১৪০০ বছর আগে আল কুরআনে বর্ণনা করা যাওয়া সব ঘটনা বা তথ্যের আলোকে।
এছাড়াও এ বইয়ে কুরআন আর বাইবেলের তথ্য নিয়ে দেখিয়েছেন গবেষণামূলক তুলনা। কুরআনে বর্ণনা করা ঘটনা নিয়ে (সেকাল) মহানবী হযরত মুহম্মদ (সঃ) এর সময়কার ঘটনা আর বর্তমানে (একাল) বিভিন্ন গবেষণায় কর্মরত বিশিষ্ট ব্যক্তিদের মতবাদ।</p>
  ...
  <article class="col-md-12">
    <hr>
    <h4 style="color:#ff0000;">Save Extra with offer</h4>
    <!--list of offers-->
    <ul>
      <li>Buy 3 books and get 1 book free !</li>
