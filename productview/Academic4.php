...
<!--product details-->
 <aside class="3">
    <img src="../imagess/acb4.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">Advanced Engineering Mathematics </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Erwin Kreyszig</span></p>
    <hr>

  

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Publisher: Paperback<br>৳ 220</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 220<br>
    M.R.P: <del>৳ 350</del><br>
    You save: ৳ 130<br>
  ...
  <a class="form-control" href="http://localhost/9/user/login.php" button type="button" class="btn btn-light bt" style="text-align:center;background-color:aqua">Add to cart</button></a>
    <p style="margin-left:20px;"><i class="material-icons">add_location</i>Delivered 150 copies</p>
  </aside>
<!--next section-->
<section class="row">
<article class="col-md-6" style="margin-left:320px;">
Title: Advanced Engineering Mathematics <button id="sh">See more...</button>
    <p id="pp">Author: Erwin Kreyszig.
               Edition: 10th.
               Publisher: Paperback.
               ISBN: 978-8126554232 </p>
