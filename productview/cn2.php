...
<!--product details-->
 <aside class="3">
    <img src="../imagess/cn2.png" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">বেসিক আলী </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">শাহরিয়ার </span></p>
    <hr>


    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">পাঞ্জেরী পাবলিকেশন্স <br>৳ 150</p><br>
...
<section class="row">
  ...
  বেসিক আলী হচ্ছে বিশিষ্ট ঋণখেলাপী ব্যবসায়ী, তালিব আলী ও তার স্ত্রী মলি আলীর বড় ছেলে, <button id="sh">Read more...</button>
    <p id="pp">বেসিকের ছোট বোন নেচার আলী মেডিকেল কলেজের ছাত্রী ও ছোট ভাই ম্যাজিক স্কুলের ছাত্র। বেসিকের ঘনিষ্ঠ বন্ধু আত্মভোলা হিল্লোল এবং বেসিকের হৃদকম্প হচ্ছে অফিস কলিগ রিয়া হক।
এদের সবাইকে নিয়েই অনবদ্য কার্টুন স্ট্রিপ-বেসিক আলী।</p>
