...
<!--product details-->
 <aside class="3">
    <img src="../imagess/lord.jpg" alt="crimson book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #ff0066">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">Lord Of Shadows </span><span style="color:#ff3300">Paperback</span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Tanya Anne</span></p>
    <hr>

    <a href="#"><p>> see all formats edition</p></a>

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Paperback<br>₹ 300</p><br>

    <p>Delivery By: Tuesday,January 18 <a href="#">Details</a><span></span></p>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;">₹ 300<br>
    M.R.P: <del>₹ 450</del><br>
    You save: ₹ 150<br>
  ...
  <p><button class="form-control" style="text-align:center;background-color:rgba(255, 204, 0)">Add to cart</button><br><button class="form-control" style="text-align:center;background-color:rgba(255, 102, 0,0.8)">Buy Now</button></p>
