...
<!--product details-->
 <aside class="3">
    <img src="../imagess/nv2.png" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">আজ হিমুর বিয়ে </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"> হুমায়ূন আহমেদ</span></p>
    <hr>

   

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">অন্যপ্রকাশ<br>৳ 213</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 213<br>
...
<section class="row">
  ...
  হুমায়ূন আহমেদ ছিলেন একজন বাংলাদেশী ঔপন্যাসিক, নাট্যকার, চিত্রনাট্যকার, চলচ্চিত্র নির্মাতা, গীতিকার এবং প্রভাষক, <button id="sh">Read more...</button>
    <p id="pp"> তিনি বিংশ শতাব্দীর জনপ্রিয় বাঙালি কথাসাহিত্যিকদের মধ্যে অন্যতম। তাকে বাংলাদেশের স্বাধীনতা পরবর্তী অন্যতম শ্রেষ্ঠ লেখক বলে গণ্য করা হয়। তার বেশ কিছু গ্রন্থ পৃথিবীর নানা ভাষায় অনূদিত হয়েছে, বেশ কিছু গ্রন্থ স্কুল-কলেজ বিশ্ববিদ্যালয়ের পাঠ্যসূচীর অন্তর্ভুক্ত।</p>
