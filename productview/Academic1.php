...
<!--product details-->
 <aside class="3">
    <img src="../imagess/acb1.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">Fundamentals of Physics </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Jearl Walker</span></p>
    <hr>

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Publisher: Wiley<br>৳ 250</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 250<br>
...
<section class="row">
  ...
  Title: Fundamentals of Physics. <button id="sh">See more...</button>
    <p id="pp">Author: Jearl Walker.
               Edition: 10th.
               Publisher: Wiley.
               ISBN: 978-1118230732.</p>
