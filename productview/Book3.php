...
<!--product details-->
 <aside class="3">
    <img src="../imagess/BS3.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">ম্যাসেজ </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"> মিজানুর রহমান আজহারি</span></p>
    <hr>

   

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">গার্ডিয়ান পাবলিকেশনস<br>৳ 200</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 200<br>
    M.R.P: <del>৳ 300</del><br>
    You save: ৳ 100<br>
...
<section class="row">
  ...
  টুন টুন শব্দে মুটোফোনে একটি ম্যাসেজ আসল । নজর ফেলতেই দেখলাম । উপরের বাক্যটি । হ্যাঁ , আপনি উপরে যে বাক্য দেখছেন তা আমাদের জন্য দ্বীনের দাওয়াতের একটি বার্তা । আপনার একটি দৃঢ় সিদ্ধান্ত বদলে দিতে পারে আপনার ইহকাল – পরকাল । <button id="sh">Read more...</button>
    <p id="pp">আধারে ঢাকা আবরণ সরিয়ে আলােকিত করতে পারে আপনার সবকিছু । ঠিক আমাদের মুঠোফোনে টেক্সট আসে যেভাবে সেভাবেই ‘ ম্যাসেজ ‘ আধুনিক মননে দ্বীনের ছোঁয়া গ্রন্থটির মাধ্যমে কুরআনের ম্যাসেজগুলাে পাঠকের কাছে ১২ টি টেক্সটের মাধ্যমে পৌঁছে দেওয়া হয়েছে ।

প্রচ্ছদেই দেওয়া আছে -‘You have 12 unread messages ! ‘ যা ২১ শতকের মরীচিকার পেছনে ছুটে চলা তারুণ্যের জন্য মাস্টরিড একটি বই । কারণ এই নতুন প্রজন্মকে যদি সঠিক পরিবহনে তুলে দেওয়া যায় , তাহলে সঠিক গন্তব্যে পৌঁছবেই ।</p>
