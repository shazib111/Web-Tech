...
<!--product details-->
 <aside class="3">
    <img src="../imagess/hr3.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">অদ্ভুত সব গল্প </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"> হুমায়ূন আহমেদ</span></p>
    <hr>


    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">পার্ল পাবলিকেশন্স<br>৳ 175</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 175<br>
    M.R.P: <del>৳ 250</del><br>
    You save: ৳ 75<br>
  ...
  <a class="form-control" href="http://localhost/9/user/login.php" button type="button" class="btn btn-light bt" style="text-align:center;background-color:aqua">Add to cart</button></a>
    <p style="margin-left:20px;"><i class="material-icons">add_location</i>Delivered 100 copies</p>
  </aside>
<!--next section-->
<section class="row">
  <article class="col-md-6" style="margin-left:320px;">
  অদ্ভুত সব গল্প – হুমায়ূন আহমেদ এর লেখা একটি বাংলা জনপ্রিয় বই। আমাদের টিম তার “অদ্ভুত সব গল্প” বইটি সংগ্রহ করেছি এবং আপনাদের জন্য হুমায়ূন আহমেদ  <button id="sh">Read more...</button>
    <p id="pp">হুমায়ুন আহমেদ একজন কথার জাদুকর। খুব সাধারন একটা ঘটনা তিনি এমন ভাবে তার মায়া মাখা বাক্য দিয়ে সাজিয়ে তোলেন যেন কোন শিল্পী তার ক্যানভাসে সবটুকু মায়া ঢেলে তার প্রেয়সীর মুখ ফুটিয়ে তুলেছে।
পড়া শেষ করলাম লেখকের “অদ্ভুত সব গল্প” বইটা। অদ্ভুত অদ্ভুত কয়েকটা গল্পের সঙ্কলন এটা। এখানে লেখকের পাঁচটা ছোট গল্প স্থান পেয়েছে। যার প্রত্যেকটা অসাধারন লেগেছে।
সংকলনের প্রথম গল্পের নাম গুনীন। গল্পটি একজন গুনীন কে নিয়ে যার নাম চান্দ শাহ ফকির, তন্ত্র মন্ত্র নিয়ে তার কাজ। কিন্তু যুগ আধুনিক হচ্ছে দূর্বার গতিতে, এখন কি আর তন্ত্র মন্ত্র নিয়ে মানুষের চিন্তা করার সময় আছে। তাই ব্যাবসার অবস্থা ভালো যায়না গুনীনের। ওদিকে ঘরে শয্যাশায়ী স্ত্রী যার শরীর না চললেও মুখ চলে। এই গুনীন এর ভন্ডামি তুলে ধরতে ধরতে হঠাৎ লেখক একটা মোচর মেরেছেন। মোচরটা কি বলবো না। মজা নষ্ট হয়ে যাবে।
</p>
