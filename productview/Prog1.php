...
<!--product details-->
 <aside class="3">
    <img src="../imagess/Cp1.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">The Complete Reference C++ </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Herbert Schildt</span></p>
    <hr>



    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">McGraw-Hill<br>৳ 350</p><br>
...
<section class="row">
  ...
  Title: The Complete Reference C++. <button id="sh">Read more...</button>
    <p id="pp">Author: Herbert Schildt.
                Edition: 4th.
