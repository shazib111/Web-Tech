...
<!--product details-->
<aside class="3">
    <img src="../imagess/cn1.png" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">নীলকণ্ঠ রহস্য </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">মেহেদী হক</span></p>
    <hr>

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">ঢাকা কমিক্স<br>৳ 100</p><br>
...
<p style="margin-left:20px;"> Price: ৳ 100<br>
