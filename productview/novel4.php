...
<!--product details-->
 <aside class="3">
    <img src="../imagess/nv4.png" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">লালসালু </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">সৈয়দ ওয়ালীউল্লাহ্</span></p>
    <hr>


    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">কমরেড পাবলিশার্স<br>৳ 120</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 120<br>
    M.R.P: <del>৳ 150</del><br>
    You save: ৳ 30<br>
...
<section class="row">
  ...
  লালসালু বাঙালি লেখক সৈয়দ ওয়ালীউল্লাহ রচিত অভিষেক উপন্যাস, <button id="sh">Read more...</button>
    <p id="pp">১৯৪৮ সালে রচিত এবং প্রকাশিত উপন্যাসটি বাংলা সাহিত্যের ধ্রুপদী সৃষ্টিকর্ম হিসেবে বিবেচিত। এর পটভূমি ১৯৪০ কিংবা ১৯৫০ দশকের বাংলাদেশের গ্রামসমাজ হলেও এর প্রভাব বা বিস্তার কালোত্তীর্ণ। মূলত গ্রামীণ সমাজের সাধারণ মানুষের সরলতাকে কেন্দ্র করে ধর্মকে ব্যবসার উপাদানরূপে ব্যবহারের একটি নগ্ন চিত্র উপন্যাসটির মূল বিষয়।</p>
