...
<!--product details-->
 <aside class="3">
    <img src="../imagess/acb2.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">Calculus </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">Howard Anton</span></p>
    <hr>

  

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">Publisher: Wiley<br>৳ 300</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 300<br>
    M.R.P: <del>৳ 380</del><br>
    You save: ৳ 80<br>
...
<article class="col-md-6" style="margin-left:320px;">
     Title: Calculus. <button id="sh">See more...</button>
    <p id="pp">Author: Howard Anton.
              Edition: 10th.
              Publisher: Wiley.
              ISBN: 978-8126556403.</p>
