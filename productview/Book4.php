...
<!--product details-->
 <aside class="3">
    <img src="../imagess/BS4.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">প্রোডাক্টিভ মুসলিম </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"> মোহাম্মদ ফারিস</span></p>
    <hr>

  

    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">গার্ডিয়ান পাবলিকেশনস<br>৳ 380</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 380<br>
...
<section class="row">
  ...
  মুসলমানরা প্রোডাক্টিভ জাতি। মুসলিম দাবিদার

প্রত্যেকেই প্রোডাক্টিভ জীবনযাপন করতে বাধ্য। দুর্ভাগ্যজনকভাবে ইসলামি জীবন-পদ্ধতি ও রুটিনকে প্রােডাক্টিভিটির পথে

বাধা হিসেবে চিহ্নিত করা হয়েছে। <button id="sh">Read more...</button>
    <p id="pp">সত্যিই কি তাই আমৱা এই গ্রন্থে সে প্রশ্নের সমাধান খুঁজব। জীবনধারণের বাস্তবসম্মত
...
সময়কে আখিরাতের জনা বিনিয়ােগ করবেন?</p>
