...
<!--product details-->
 <aside class="3">
    <img src="../imagess/cn4.png" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">দুর্জয় ভলিউম ১ </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese">তৌহিদুল ইকবাল </span></p>
    <hr>


    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">ঢাকা কমিক্স <br>৳ 350</p><br>
...
<section class="row">
  ...
  এই ভলিউম পড়ার পর পাঠকরা ৬ থেকে ১০ পর্ব গুলি খুঁজবে, কিন্তু এই সব পর্বগুলি আর রি-প্রিন্ট হয়নি, <button id="sh">Read more...</button>
    <p id="pp">তাই বাজারেও পাওয়া যাবে না। অসম্পূর্ণ গল্পের একটা আক্ষেপ থেকে যাবে। ঢাকা কমিক্স আবার কবে ৬-১০ পর্ব নিয়ে ভলিউম প্রকাশ করবে, তার কোন ঘোষণা দেয়নি। তাই ভলিউম ১-৫ না ক।</p>
