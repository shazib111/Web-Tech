...
<!--product details-->
 <aside class="3">
    <img src="../imagess/hr2.jpg" alt="book cover picture" style="width:300px;box-shadow:2px 2px 4px 4px #00ffff">
  </aside>
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd">মেঘের ওপর বাড়ি </span><span style="color:#ff3300"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"> হুমায়ূন আহমেদ</span></p>
    <hr>


    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">	অন্যপ্রকাশ<br>৳ 230</p><br>
  ...
  <aside class="2" style="margin-left:10px;border:1px solid black;box-shadow:1px 1px 2px 2px  #adad85;padding:10px;">
    <p style="margin-left:20px;"> Price: ৳ 230<br>
    M.R.P: <del>৳ 400</del><br>
    You save: ৳ 170<br>
...
<section class="row">
  ...
  লাশকাটা ঘরের পলিথিন বিছানো নোংরা টেবিলে আমার শরীর চিত হয়ে আছে। গায়ে আমার কোনো কাপড় নেই। <button id="sh">Read more...</button>
    <p id="pp">টেবিল থেকে ফিনাইলের কঠিন গন্ধ আসছে। ঘরের জানালা আছে। জানালায় হলুদ রঙের পর্দা ঝুলছে। পর্দা নোংরা। সেখানে কিছু বড় বড় নীল রঙের মাছি বসে আছে। মাছিগুলো কিছুক্ষণ বসে থাকে আবার ওড়াউড়ি করে পর্দার ওপর বসে। ঘরের চারটা দেয়ালের একটায় চুনকাম করা হয়েছে।প্রথম আলো ঈদসংখ্যার জন্য যখন আমি এই উপন্যাস লিখি, তখন ক্যান্সার নামক জটিল ব্যাধি আমার শরীরে বাসা বেঁধেছে। এই খবরটা আমি জানি না। ক্যান্সার সংসার পেতেছে কোলনে, সেখান থেকে রক্তের ভেতর দিয়ে সারা শরীরে ছড়ানোর চেষ্টা চালাচ্ছে। কোনো এক অদ্ভুত কারণে আমার অবচেতন মন কি এই খরবটা পেয়েছে?
