...
<aside class="6" style="margin-left: 50px;">
    <h2><span class="prdhd" style="font-size: 23px;"><?php echo $row['title'];?></span><span style="color:#ff3300;"></span></h2>
    <p>by <span style="color:#33ccff;font-size:20px;font-family:Simplified Chinese"><?php echo $row['author']; ?></span></p>
    <hr>



    <p style="border:1px solid black;display:inline-block;padding:2px;margin-left:3px;box-shadow: 1px 1px 2px 2px #505e62">100+ Copies Available<br>৳ <?php echo $row['sprice']; ?></p><br>
    ...
    <p><a href="#"  class="log"  style="font-size:12px;">No-contact Delivery</a><a href="#"  class="log" style="font-size:12px;">10 Days Replacement Only</a><a href="#"  class="log" style="font-size:12px;">Delivery Via G-9 Book Shop</a></p>
  ...
  <p><input type="submit" name="ad" class="form-control" style="text-align:center;background-color:aqua" value="Buy Now"><br>
    
  <p style="margin-left:20px;"><i class="material-icons">add_location</i>Delivery by G-9 Book Shop</p>
</form>
  </aside>
...
<section class="row">
  ...
  <article class="col-md-12">
    ...
    <!--list of offers-->
    <ul>
      <li>Buy 3 books and get 1 free</li>
    </ul>
    <hr>
  </article>
</section>
