...
<div class="container">
  ...
  <a class="navbar-brand" href="../index.php">
    <img class="profile" src="img/G9 LOGO.png" alt="logo" style="width:82px;">
  </a>
  ...
  <ul class="navbar-nav">
   ...
   <li class="nav-item" style="margin-left:20px;font-weight: bold">
    <a class="nav-link" href="http://localhost/9/index.php">Home</a>
   </li>
...
<section class="row">
  ...
  <article class="col-md-12">
   ...
   <div class="frmmm" id="xxx" >
     <form class="rt" action="" method="post" class="po" enctype='multipart/form-data' name="form2">
     
      <div class="frmmm" id="xxx" >
         <form class="rt" action="" method="post" class="po" enctype='multipart/form-data' name="form2">
         
        <p style="float:left;"><img class="fl" src="logo/APanel.png" width=1080px; height="500px"></p>
        
        <h1 style="font-family: kalam;font-weight: bold; margin-top: 50px; margin-left: 530px;">  Menu  </h1>
      <table>

      <tr><th>
                <a class="form-control" href="https://localhost/9/admin/addproduct.php" button type="button" class="btn btn-light bt" style="text-align:center; width:385px; height:35px; margin-left: 370px; background: #66ffff">Add Book</button></a>
          </th></tr>
     <tr><th>
                <a class="form-control" href="https://localhost/9/admin/products.php" button type="button" class="btn btn-light bt" style="text-align:center; width:385px; height:35px; margin-left: 370px; background: #66ffff">Books</button></a>
          </th> </tr>
     <tr><th>
                <a class="form-control" href="logoutfetch.php" button type="button" class="btn btn-light bt" style="text-align:center; width:385px; height:35px; margin-left: 370px; background: #66ffff">Logout</button></a>
          </th></tr>
