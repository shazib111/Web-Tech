  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <form action="productfetch.php" method="post" enctype="multipart/form-data" style="color:black;">
        <p class="pp">Title:</p>
        <p><input type="text" name="title"placeholder="Enter book name" required></p>
        <p class="pp">Author:</p>
        <p><input type="text" name="author"placeholder="Enter author name" required></p>
        <p>Category: <br><br>
          <select name="type">
              ...
              <option value="Promgramming">Computer Programming</option>
