    ...
    ?>
      <tr>
          ...
          <td><?php echo $row['prices']; ?></td>
                     ...
                     <td><a onclick="return confirm('Are you want to delete this book?')" href="deleteproducts.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>

           <td><a href="updateproducts.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Update</a></td>
      </tr>
      </tr>
